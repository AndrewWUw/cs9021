 ...
 *              the longest, leftmost good subsequence of the input (between   *
 *              two good subsequences of different length, the longest is      *
 *              preferred; between two good subsequences of the same length,   *
 *              the leftmost is preferred). The program reports an error       *
 *              message in case the input contains nonlowercase letters or     *
 *              more than 20 lowercase letters before the final new line       *
 *              character.                                                     *
 *                                                                             *
