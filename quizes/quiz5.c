...
int size_of_largest_parallelogram_with_given_top_side_STRAIGHT(int i1, int j1, int j2);
int size_of_largest_parallelogram_with_given_top_side_LEFT(int i1, int j1, int j2);
int size_of_largest_parallelogram_with_given_top_side_RIGHT(int i1, int j1, int j2);
...
int size_of_largest_parallelogram(void) {
    ...
    for (int i = 0; i < DIM; i++) {
        ...
        if (size < size_of_largest_parallelogram_with_given_top_side(i, j1, j2, LEFT)) {
            size = size_of_largest_parallelogram_with_given_top_side(i, j1, j2, LEFT);
        } else if (size < size_of_largest_parallelogram_with_given_top_side(i, j1, j2, RIGHT)) {
